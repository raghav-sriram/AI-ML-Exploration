...
# 1 Sriram Raghav Othello AI Level 1 BLUE
# 1 Sriram Raghav Othello AI Level 2 RED
# oth_corners_predictable_import
# oth_corners_unpredictable_import
# oth_random_import
p1 = "1 Sriram Raghav Othello AI Level 1 BLUE.py"
